...
public interface ComplexDataContainer {
    ...
    interface DataContainer3<T1, T2, T3> extends DataContainer2<T1, T2> {
        T3 getData3(ItemStack itemStack);

        void setData3(ItemStack itemStack, T3 data);
    }

    interface DataContainer4<T1, T2, T3, T4> extends DataContainer3<T1, T2, T3> {
        T4 getData4(ItemStack itemStack);

        void setData4(ItemStack itemStack, T4 data);
    }

    interface DataContainer5<T1, T2, T3, T4, T5> extends DataContainer4<T1, T2, T3, T4> {
        T5 getData5(ItemStack itemStack);

        void setData5(ItemStack itemStack, T5 data);
    }

    interface DataContainer6<T1, T2, T3, T4, T5, T6> extends DataContainer5<T1, T2, T3, T4, T5> {
        T6 getData6(ItemStack itemStack);

        void setData6(ItemStack itemStack, T6 data);
    }

    interface DataContainer7<T1, T2, T3, T4, T5, T6, T7> extends DataContainer6<T1, T2, T3, T4, T5, T6> {
        T7 getData7(ItemStack itemStack);

        void setData7(ItemStack itemStack, T7 data);
    }

    interface DataContainer8<T1, T2, T3, T4, T5, T6, T7, T8> extends DataContainer7<T1, T2, T3, T4, T5, T6, T7> {
